                    ...
                    <div class="overflow-x-auto">
                        ...
                        <table class="min-w-full bg-white dark:bg-gray-700 rounded-lg overflow-hidden">
                            <thead class="bg-gray-100 dark:bg-gray-600">
                                <tr>
                                    <th
                                        class="w-1/2 px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                        Name</th>
                                    <th
                                        class="w-1/2 px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                        Actions</th>
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-500">
                                @foreach ($roles as $role)
                                    <tr class="group hover:bg-gray-50 dark:hover:bg-gray-600">
                                        <td class="px-6 py-4">
                                            <div class="truncate max-w-xs">{{ $role->name }}</div>
                                        </td>
